...
def monitor_and_forward(interface, forward_interface1, forward_interface2 = None):
    ...
    packet_queue = Queue(maxsize=10000)  # Possiamo regolare la dimensione della coda a seconda delle esigenze

    # Avvio i thread lavoratori
    for _ in range(1000):  # Possiamo regolare il numero di thread a seconda delle esigenze
